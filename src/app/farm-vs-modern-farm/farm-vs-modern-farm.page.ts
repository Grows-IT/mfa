...
export class FarmVsModernFarmPage implements OnInit {
  ...
  public oldTotalCost;
  public sugarcaneArea;
  public modernTotalCost;
  public reduceCost;
  public increaeResultPerRai;
  public increaseIncomeByArea;
  public totalIncrease;
  ...
  calculate(): void {
    ...
    this.increaseIncomeByArea=Math.floor(this.sugarcaneArea*(modernIncome-oldIncome))
    this.totalIncrease=Math.floor(this.reduceCost+this.increaseIncomeByArea)
    this.lineChartMethod();
